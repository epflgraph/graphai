...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='scraping.init_scraping', ignore_result=False)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='scraping.process_all_scraping_sublinks_parallel', ignore_result=False)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='scraping.sublink_parallel_processing_merge_callback', ignore_result=False)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='scraping.remove_junk_scraping_parallel', ignore_result=False)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='scraping.extract_scraping_content_callback', ignore_result=False)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='scraping.scraping_dummy_task', ignore_result=False)
