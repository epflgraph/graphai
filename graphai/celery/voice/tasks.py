...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='voice_gpu.init_transcription', ignore_result=False,
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='caching.cache_lookup_fingerprint_audio', ignore_result=False)
def cache_lookup_audio_fingerprint_task(self, token):
    return cache_lookup_audio_fingerprint(token)


@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='caching.cache_lookup_detect_language_audio', ignore_result=False)
def cache_lookup_audio_language_task(self, token):
    return cache_lookup_audio_language(token)


@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True,
             retry_kwargs={"max_retries": 2}, name='voice_gpu.detect_language_retrieve_from_db', ignore_result=False,
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True,
             retry_kwargs={"max_retries": 2}, name='voice_gpu.detect_language_parallel', ignore_result=False,
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True,
             retry_kwargs={"max_retries": 2}, name='voice_gpu.detect_language_callback', ignore_result=False,
             file_manager=file_management_config)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='caching.cache_lookup_transcribe_audio', ignore_result=False)
def cache_lookup_audio_transcript_task(self, token):
    return cache_lookup_audio_transcript(token)


@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True,
             retry_kwargs={"max_retries": 2}, name='voice_gpu.transcribe', ignore_result=False,
             file_manager=file_management_config, model=transcription_model)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='voice_gpu.transcribe_callback', ignore_result=False,
             file_manager=file_management_config)
...
@shared_task(bind=True, autoretry_for=(Exception,), retry_backoff=True, retry_kwargs={"max_retries": 2},
             name='voice_gpu.clean_up_transcription_object', model=transcription_model, ignore_result=False)
