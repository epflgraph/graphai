...
def retrieve_lex_job(text, index_to_search_in, lang_filter=None, cat_filter=None, limit=10):
    task_list = [
        embed_text_task.s(text, RETRIEVAL_PARAMS[index_to_search_in]['model']),
        retrieve_from_es_task.s(text, index_to_search_in, lang_filter, cat_filter, limit)
    ]
